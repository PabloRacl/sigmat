...
describe('EquipmentController', () => {
  ...
  const usuario = { id: 1, perfil: 'ADMIN_DTEC', nome: 'Admin' };
  ...
  it('deve repassar o usuario autenticado ao service.criar', async () => {
    const outroUsuario = { id: 2, perfil: 'USUARIO_BATALHAO' };
    const dto = {
      patrimonio: 'PAT-005',
      tipoEquipamentoId: 1,
      statusId: 1,
  ...
  it('deve repassar o usuario autenticado ao service.atualizar', async () => {
    const outroUsuario = { id: 3, perfil: 'COMANDANTE' };
  ...
  it('deve repassar o usuario autenticado ao service.remover', async () => {
    const outroUsuario = { id: 4, perfil: 'USUARIO_BATALHAO' };
  ...
  it('deve repassar o usuario autenticado ao service.atualizarEmMassa', async () => {
    const outroUsuario = { id: 5, perfil: 'ADMIN_DTEC' };
