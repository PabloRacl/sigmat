...
export class PdfService {
  ...
  async gerarCautela(item: any): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      ...
      doc.fontSize(11);
      doc.text('POLÍCIA MILITAR DE PERNAMBUCO  |  DTEC - ATLAS V2', this.mmToPt(20), this.mmToPt(14));
      ...
      doc.font('Helvetica');
      doc.fontSize(11);
      const declaracao = 'Pelo presente termo, declaro ter recebido da carga do ATLAS/PMPE o material descrito abaixo, assumindo plena responsabilidade por sua guarda e conservação:';
      ...
      // Rodapé
      doc.fontSize(7);
      doc.text(`Documento gerado automaticamente pelo ATLAS em ${dataAtual} às ${horaAtual}`, this.mmToPt(20), this.mmToPt(18));
