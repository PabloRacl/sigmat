...
| R-2.14 | Upload de fotos do equipamento (campo JSON no schema, implementação frontend concluída) | 2 dias | ✅ |
...
| R-12.10 | Documentação Swagger/OpenAPI | 2 dias | ✅ |
...
> **Situação atual:** 100% concluído (Upload de fotos e Swagger finalizados)
