export interface IAprovacaoRepositorio {
  criar(equipamentoId: number, solicitanteId: number, dadosNovos: any, dadosAntigos: any, camposAlterados: string[]): Promise<any>;
  ...
  processarDecisao(id: number, aprovado: boolean, aprovadoPorId: number, motivoNegacao?: string, dadosTransacao?: any): Promise<any>;
}
